    ...
    <head>
        ...
        <style>
            ...
            *{box-sizing:border-box}
            ...
            .error{background:#ffe6e6;border:1px solid #ffb3b3;color:#8a1414;padding:10px;border-radius:8px;margin-bottom:12px}
            ...
            <div class="card">
                <div class="left">
                    ...
                    <form action="<?= esc($action) ?>" method="post" autocomplete="off">
                        ...
                        <div class="bottom">
                            Need an account? <a href="<?= esc(function_exists('base_url') ? base_url('SignupPage.php') : '/signup') ?>">Sign up</a>
                        </div>
                    </form>
                </div>
                <div class="right">
